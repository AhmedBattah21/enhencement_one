 ...
 * @author Computer
 */
public class StudentsListPdfCreator {
    ...
    public static void creator(String query, String path) {
        ...
        try {
            ...
            reportgenthree.views.ProcessCompleteController.setPath(path + "/Student List Document -" + formatter.format(date) + ".pdf");
            ...
            try {
                ...
                while (rst.next()) {
                    ...
                    if (numstudents == 1) {
                        ...
                        setTableTitle("Full Name", "Admission Number", "Stream", ContentSection, "S/No");
                    ...
                    setNamesToCell(stname, ccode + "/" + admnumber, classname, ContentSection, count);
                    count++;
    ...
    public static void showProcessComplete() {
        ...
        ReportGenThree.LoadProcessCompleteBox();

 ...
 * @author Computer
 */
public class ScoreEDTSheetPdfCreator_v2 {
        ...
        try {
            ...
            try {
                ...
                while (rst.next()) {
                    ...
                    String std_name = AppFuctions.StudentsClass.getStdName(admnumber);
                    ...
                    populateTableWithData(std_name, getCcode(admnumber) + "/" + admnumber, mid, end, end_totals, unitremark, ContentSection, count);
                    count++;
    ...
    public static String getComment(int p_score) {
        String comment = "poor";

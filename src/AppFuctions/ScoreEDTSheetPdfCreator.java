 ...
 * @author Computer
 */
public class ScoreEDTSheetPdfCreator {
    ...
    public static void creator(String query, String path) {
        ...
        try {
            ...
            FileOutputStream out = new FileOutputStream(path + "/Student List Document -" + formatter.format(date) + ".pdf");
            publicPath = path + "/Student List Document -" + formatter.format(date) + ".pdf";
            ...
            //content section
            PdfPTable ContentSection = new PdfPTable(7);
            ContentSection.setWidthPercentage(100);
            ContentSection.setSpacingBefore(5);
            ContentSection.setWidths(new int[]{5, 15, 10, 10, 10, 10, 10});
            ...
            try {
                ...
                while (rst.next()) {
                    ...
                    if (numstudents == 1) {
                        ...
                        setTableTitle("Full Name", "Admission Number", "MID(/30)", "END(/70)", "Totals(/100)", "Remark", ContentSection, "S/NO");
                    ...
                    String totals = Integer.toString(Integer.parseInt(end) + Integer.parseInt(mid));

                    String remark = getComment(totals);

                    populateTableWithData(stname, getCcode(admnumber) + "/" + admnumber, mid, end, totals, remark, ContentSection, count);
                    count++;
    ...
    public static void populateTableWithData(String stname, String adm, String mid, String end, String totals, String remark, PdfPTable table, int count) {

        Chunk count_1 = new Chunk(Integer.toString(count));
        Chunk stname_1 = new Chunk(stname);
        Chunk adm_1 = new Chunk(adm);
        Chunk mid_1 = new Chunk(mid);
        Chunk end_1 = new Chunk(end);
        Chunk totals_1 = new Chunk(totals);
        ...
        if (count % 2 != 0) {
            ...
            c3_1.setBackgroundColor(new BaseColor(Functions.getRedColor(row1), Functions.getGreenColor(row1), Functions.getBlackColor(row1), 1));
            c3_2.setBackgroundColor(new BaseColor(Functions.getRedColor(row1), Functions.getGreenColor(row1), Functions.getBlackColor(row1), 1));
            ...
            c3_1.setBackgroundColor(new BaseColor(Functions.getRedColor(row2), Functions.getGreenColor(row2), Functions.getBlackColor(row2), 1));
            c3_2.setBackgroundColor(new BaseColor(Functions.getRedColor(row2), Functions.getGreenColor(row2), Functions.getBlackColor(row2), 1));
        ...
        c3.addElement(addtitletwo(mid_1));
        c3_1.addElement(addtitletwo(end_1));
        c3_2.addElement(addtitletwo(totals_1));
    ...
    public static void setTableTitle(String stname, String adm, String mid, String end, String totals, String Remark, PdfPTable table, String count) {
        ...
        c3_1.setBackgroundColor(new BaseColor(getRedColor(HeaderFontColor), getGreenColor(HeaderFontColor), getBlackColor(HeaderFontColor), 1));
        c3_2.setBackgroundColor(new BaseColor(getRedColor(HeaderFontColor), getGreenColor(HeaderFontColor), getBlackColor(HeaderFontColor), 1));
        ...
        c3.addElement(FormatTableColumnHeaders(mid_1));
        c3_1.addElement(FormatTableColumnHeaders(end_1));
        c3_2.addElement(FormatTableColumnHeaders(totals_1));
    ...
    public static String getComment(String scoreone) {
        String comment = "poor";
